<template>
  <div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="mb-4">
      <label class="block mb-2 font-medium" style="color: red;">博客内容（支持富文本）：</label>
      <QuillEditor
    ...
    <div class="mb-4">
      <label class="block mb-2 font-medium" style="color: red;">封面图上传：</label>
      <input type="file" style="color: rgb(72, 63, 63);" @change="handleCoverUpload" />
      <div v-if="coverUrl" class="mt-2 text-green-600" style="color: red;">已上传：{{ coverUrl }}</div>
    </div>
